...
describe Board do
  ...
  it 'has cells' do
    ...
    expect(board.cells.keys).to eq(cells)
  end
  ...
  it 'has same number of coordinates as length of ship' do
    board = Board.new
  ...
  it 'has coordinates that are either horizontal or vertical' do
    board = Board.new
    cruiser = Ship.new("Cruiser", 3)
    submarine = Ship.new("Submarine", 2)
  ...
  it 'is a valid placement if all previous tests pass' do
    board = Board.new
    cruiser = Ship.new("Cruiser", 3)
    submarine = Ship.new("Submarine", 2)
  ...
  it 'can split coordinates into letters and numbers' do
    board = Board.new
  ...
  it 'cannont place ships that overlap an existing ship' do
    board = Board.new
    cruiser = Ship.new("Cruiser", 3)
    submarine = Ship.new("Submarine", 2)
